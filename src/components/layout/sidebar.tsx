...
const Sidebar = () => {
    ...
    const linkClasses = (path: string) =>
        `flex h-9 w-9 items-center justify-center rounded-lg transition-colors md:h-8 md:w-8 ${activeLink === path ? "text-foreground bg-accent" : "text-muted-foreground hover:text-foreground"
        }`;
