...
//     }
//   );
//   const { data: searchCustoemrs } = useSearchCustomersQuery(
//     customerSearchTerm,
//     {
...
//     try {
//       const response = await useGetCustomerDetailsQuery(
//         customer.id || ""
//       ).unwrap();
...
//           total: calculateValue(product.product),
//         }))
//       );
//     }
//   }, [invoice]);
...
//     if (newQuantity > Number(availableQuantity)) {
